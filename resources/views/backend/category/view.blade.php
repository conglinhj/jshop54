...
@section('title_admin','view info Category')
@push('meta_content')
...
@section('content')
    ...
    <div class="page-heading">
        <h1><i class='icon-info-circled-2'></i> Details {{$details_category['name']}}</h1>
        ...
        <div class="col-md-7">
            <div class="widget">
                <div class="widget-header transparent">
                    <h2><a href="{{ route('backend.category.list') }}"><i class="icon-back"></i>back to list</a></h2>
                ...
                <div class="widget-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="toolbar-btn-action">
                                    <a href="{{ route('backend.category.showEditForm',['id' => $details_category['id']]) }}" class="btn btn-success"><i class="fa fa-edit"></i> Edit</a>
                                    <a class="btn btn-danger"
                                       onclick="event.preventDefault();document.getElementById('category_form_delete').submit();" >
                                        <i class="fa fa-trash-o"></i> Delete</a>
                                    <form id="category_form_delete" action="{{ route('backend.category.destroy') }}" method="post" style="display: none;">
                                        {{ csrf_field() }}
                                        <input type="hidden" value="{{ $details_category['id'] }}" name="category_id">
                                    </form>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table data-sortable class="table table-hover table-striped">
                            ...
                            <tr>
                                <td>Tên phần cứng</td>
                                <td><strong>{{ $details_category['name'] }}</strong></td>
                            </tr>
                            <tr>
                                <td>Ngày tạo</td>
                                <td>{{ $details_category['created_at'] }}</td>
                            </tr>
                            <tr>
                                <td>Ngày cập nhật</td>
                                <td>{{ $details_category['updated_at'] }}</td>
                            </tr>
                    ...
                    {{--<div id="basic-form">--}}
                        {{--<form id="specs_form" method="post" role="form" style="display: none;">--}}
                            ...
                            {{--<div id="specs-block" class="form-group col-md-6">--}}
                                ...
                                {{--<input type="hidden" name="category_id" value="{{ $details_category['id'] }}">--}}
