...
@section('content')
    ...
    <div class="page-heading">
        <h1><i class='fa fa-plus-circle'></i> Create new Hardware</h1>
    </div>
    <!-- Page Heading End-->
    <div class="row">

        <div class="col-sm-6 col-md-offset-3 portlets">
            ...
            <div class="widget">
                ...
                <div class="widget-content padding">
                    <div id="basic-form">
                        <form action="{{ route('backend.provider.store') }}" method="post" role="form">
                            {{ csrf_field() }}
                            <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                <label for="input-text" class="control-label">Name</label>
                                <input type="text" name="name" class="form-control" id="input-text" placeholder="tên">
                                @if($errors->has('name'))
                            ...
                            <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="email" class="form-control" id="input-text" placeholder="email">
                                @if($errors->has('email'))
                            ...
                            <div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="phone" class="form-control" id="input-text" placeholder="số điện thoạt">
                                @if($errors->has('phone'))
                            ...
                            <div id="billing_address_1_field" class="form-group {{ $errors->has('address') ? ' has-error' : '' }}">
                                ...
                                <input type="text" placeholder="tên đường, số nhà..." id="billing_address_1" name="address" class="form-control input-text" >
                            ...
                            <div class="form-group {{ $errors->has('intro') ? ' has-error' : '' }}">
                                ...
                                <textarea name="intro" class="form-control" id="input-text" placeholder="thông tin thêm về nhà cung cấp."></textarea>
                                @if($errors->has('intro'))
